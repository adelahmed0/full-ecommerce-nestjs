...
البوت بيبعت تقارير الموظفين، وكمان **يستقبل منك أي رسائل/تعليمات/تاسكات**.  
**سارة** بتستلم الوارد وتبلّغ الشخص المناسب، وبعدين عادل يفصّل لو تاسك.
...
المفروض يحصل:
1. سارة تستلم وتقول هتبلّغ مين
2. تسجيل في `telegram-inbox/latest-instruction.txt`
3. تبليغ الأشخاص المناسبين على تيليجرام
4. عادل يشرح التأثير — **من غير** فتح تاسك
...
المفروض يحصل:
1. سارة تستلم التاسك وتبلّغ عادل (وأي حد مذكور)
